...
public class PageVo {
    public final int countPerPage = 5; // 한 페이지에 표시할 게시글의 개수
    public final int recordsPage; // 클라이언트가 요청한 페이지 번호
