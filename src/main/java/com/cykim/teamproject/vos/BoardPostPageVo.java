...
public class BoardPostPageVo {
    public final int countPerPage = 11; // 한 페이지에 표시할 게시글의 개수
    ...
    // 위 상수를 계산하는데 필요한 변수는 requestPage 와 totalCount 두개 임으로
    public BoardPostPageVo(int requestPage, int totalCount) {
